...
| Agent | 角色 | 职责 | 模型 |
|-------|------|------|------|
| 🐱 **nyako** | 团队管理者 | 交互 · 调度 · Session 管理 | MiniMax M2.5 |
| 👀 **monitor-neko** | 哨兵 | 高频轮询 GitHub 通知 | Gemini 3 Flash |
| ⌨️ **dev-neko** | 工程师 | 开发 · PR 处理 · ACP 调度 Codex | Codex |
| 🔍 **research-neko** | 情报员 | 技术调研 · 方案分析 | Codex |
| 📋 **plan-neko** | 策略师 | 任务拆解 · 优先级评估 | Codex |
